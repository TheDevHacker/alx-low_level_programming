 ...
 *
 * Return: pointer to the hash table created, or NULL if failed.
 */
...
/**
 * set_spair - mallocs a key/value pair
 * @key: the key.
...
/**
 * update_value - it updates the value of a given node.
...
/**
 * set_spair_front - it sets key/value pair node to front of given index's list.
 * @ht: pointer to the sorted hash table.
 * @key: the key.
...
/**
 * slist_set_first - it sets the first addition to the sorted list.
 * @ht: pointer to the sorted hash table.
...
/**
 * slist_set - it sets a new node before the given old node.
 * @ht: pointer to the sorted hash table.
 * @old_node: node where the new node is placed in front of.
 * @node: new node placed at the front of the old one.
 *
...
/**
 * slist_set_end - it sets a node at the end of the sorted list
 * @ht: pointer to the sorted hash table.
 * @node: the node placed at the end.
 *
 * Return: Always 1 (success).
 */
...
/**
 * shash_table_set - adds/updates an element to the sorted hash table.
 * @ht: pointer to the sorted hash table.
 * @key: the key.
 * @value: associated value with the key, can be an empty string.
 *
...
/* sets item in the table */
	...
	if (node == NULL)
		return (0);
/* this arranges the item in the sorted linked list */
	if (ht->shead == NULL)
 ...
 * @key: key.
 *
 * Return: associated value with the key, or NULL if fail.
 */
...
/**
 * shash_table_print - this prints in sorted order the key/value pairs.
...
/**
 * shash_table_print_rev - this prints in reverse the sorted key/value pairs.
 * @ht: sorted hash table.
 */
...
/**
 * shash_table_delete - this deletes a hash table thats sorted
 * @ht: sorted hash table.
 */
