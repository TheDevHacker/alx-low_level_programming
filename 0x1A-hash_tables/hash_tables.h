 ...
 * The key is unique in the HashTable
 * @value: The value corresponding to a key
 * @next: A pointer to the next node in List
 * @sprev: A pointer to the previous element in sorted linked list
 * @snext: A pointer to the next element in sorted linked list
 */
